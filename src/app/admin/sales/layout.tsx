...
import { salesNavItems } from "@/components/admin/sales-nav";
      ...
      <aside className="w-full shrink-0 border-b bg-muted/20 p-3 md:sticky md:top-0 md:max-h-[calc(100dvh-4rem)] md:w-56 md:self-start md:overflow-y-auto md:border-r md:border-b-0 md:p-4">
        <div className="mb-3 md:mb-4">
          ...
          <p className="hidden text-xs text-muted-foreground md:block">
            Walk-ins, reservations, deliveries, and vouchers
          </p>
        </div>
        <SalesNav className="flex-row overflow-x-auto md:flex-col md:overflow-visible" />
      </aside>
